...
public class DrawApplication {
    ...
    /*
        ...
        "Circle": (Node shape,double newRadius)
        "Ellipse": (Node shape,double newXRadius,double newYRadius)
        "Line": (Node shape,double newLineLength)
        "Polygons": (Node shape,double newCoord) => to be confirmed
        "Square": (Node shape,double newLength)
        "Rectangle": (Node shape,double newWidth,double newHeight)
        "Triangle": (Node shape,double[] xCoord,double[] yCoord)
